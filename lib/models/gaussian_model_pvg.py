...
import math
from lib.utils.pvg_general_utils import inverse_sigmoid, get_expon_lr_func, build_rotation, get_step_lr_func
from torch import nn
import os
from lib.utils.sh_utils import RGB2SH
from lib.utils.pvg_general_utils import strip_symmetric, build_scaling_rotation
from simple_knn._C import distCUDA2
from bidict import bidict
from lib.models.sky_cubemap import SkyCubeMap
from lib.models.color_correction import ColorCorrection

class GaussianModelPVG:
    def __init__(
        self, 
        model_name='pvg', 
        ...
        self.no_time_split = True
        self.t_grad = True
        self.contract = True
        self.t_init = 0.1
        self.big_point_threshold = 0.1

        self.T = 0.2
        self.velocity_decay = 1.0
        self.random_init_point = 200000
    ...
    def training_setup(self):
        ...
        l = [
            ...
            {'params': [self._t], 'lr': 0.0008, "name": "t"},
            {'params': [self._scaling_t], 'lr': 0.002, "name": "scaling_t"},
            {'params': [self._velocity], 'lr': 0.001 * self.spatial_lr_scale, "name": "velocity"},
        ...
        self.t_scheduler_args = get_expon_lr_func(lr_init=0.0008,
                                                    lr_final=0.0008 * final_decay,
                                                    lr_delay_mult=training_args.position_lr_delay_mult,
                                                    max_steps=30000)
    ...
    def densification_postfix(self, new_xyz, new_features_dc, new_features_rest, new_opacities, new_scaling,
                              new_rotation, new_t, new_scaling_t, new_velocity, new_semantic):
        d = {"xyz": new_xyz,
    ...
    def densify_and_split(self, grads, grad_threshold, scene_extent, grads_t, grad_t_threshold, N=2, time_split=False,
        ...
        self.densification_postfix(new_xyz, new_features_dc, new_features_rest, new_opacity, new_scaling, new_rotation,
                                   new_t, new_scaling_t, new_velocity, new_semantic)
    ...
    def densify_and_prune(self, max_grad, min_opacity, extent, max_screen_size=None, max_grad_t=None, prune_only=False):
        if not prune_only:
