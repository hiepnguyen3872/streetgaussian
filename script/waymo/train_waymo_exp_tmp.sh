...
for scene in "${scenes[@]}"; do
    ...
    # CUDA_LAUNCH_BLOCKING=1 CUDA_VISIBLE_DEVICES=1 python train.py --config configs/experiments_waymo/semantic_and_pseudo_depth/tmp_waymo_val_$scene.yaml
    CUDA_VISIBLE_DEVICES=1 python render.py --config configs/experiments_waymo/semantic_and_pseudo_depth/tmp_waymo_val_$scene.yaml mode evaluate
    # python render.py --config configs/experiments_waymo/street_gaussian_wo_3DOD/waymo_val_$scene.yaml mode evaluate
